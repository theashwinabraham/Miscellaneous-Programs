...
namespace sort
{
    ...
    // returns position of the element closest to end in the array satisfying element <= search
    int upperlim(int *, int, int, int = 0);
    // returns position of the element closest to beginning in the array satisfying element >= search
